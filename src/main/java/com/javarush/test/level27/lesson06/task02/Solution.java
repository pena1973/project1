...
public class Solution {
    ...
    public static boolean isNormalLockOrder(final Solution solution, final Object o1, final Object o2) throws Exception {
        ...
        Thread thread0 = new Thread()
        {
            ...
            public void run()
            {
                solution.someMethodWithSynchronizedBlocks(o1, o2); // запускаю метод
            }
        };
        ...
        System.out.println("t0 " + thread0.getState());
        System.out.println("t1 " + thread1.getState());
        result = Thread.State.BLOCKED.equals(thread0.getState())& Thread.State.TIMED_WAITING.equals(thread1.getState());
